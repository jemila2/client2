...
// // Admin Setup Check Component - MOVED INSIDE ROUTER
...
//           setShowAdminSetup(!data.adminExists); // Show setup if no admin exists
//         } else {
...
// const App = () => {
//   return (
//     <Router> {/* Router must be the outermost component */}
...
//           {/* Protected routes - Wrap with AdminSetupCheck */}
//           <Route path="/*" element={
//             <AdminSetupCheck>
//               <ProtectedRoute>
//                 <Routes>

...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col"> {/* Add flex flex-col here */}
      <Navbar/>
      
      {/* Main content that grows to push footer down */}
      <main className="flex-grow"> {/* Add this wrapper */}
        {/* Hero Section */}
        <section className="bg-blue-600 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
      ...
      {/* Footer - Only one instance here at the bottom */}
      <Footer />
    </div>
  );
};

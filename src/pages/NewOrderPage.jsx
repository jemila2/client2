...
const NewOrderPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.items.length === 0) {
      setError('Please add at least one service to your order');
      return;
    }
    ...
    try {
      ...
      // Use the createOrder function from AuthContext
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="border-t pt-4">
                ...
                <button
                  type="submit"
                  className="mt-4 w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
                  disabled={formData.items.length === 0 || isSubmitting}
                >
                  {isSubmitting ? 'Processing...' : 'Place Laundry Order'}
                </button>
              </div>
            </form>
          </div>

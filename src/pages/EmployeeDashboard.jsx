...
const EmployeeDashboard = () => {
  ...
  if (user?.role !== 'employee') {
    return (
      <div className="p-4 text-red-500">Access denied. Employees only.</div>
    );
  }
    ...
    <div className="p-6 w-full">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-4">
          ...
          <button
            onClick={() => navigate(activeTab === 'tasks' ? "/employee/tasks" : "/employee/orders/new")}
                  ...
                  {filteredTasks.map((task) => (
                    <tr key={task._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {task.orderId && (
                          <button 
                            onClick={() => navigate(`/employee/orders/${task.orderId}`)}
                  ...
                  {filteredOrders.map((order) => (
                    <tr key={order._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap font-medium">
                        <button onClick={() => navigate(`/employee/orders/${order._id}`)} className="text-blue-600 hover:underline">

...
// // // //         try {
// // // //           // 1. Try the admin-exists endpoint
...
// // // //         } catch (apiError) {
// // // //           console.log('Admin-exists endpoint failed, trying direct user check...');
          
// // // //           // 2. Try to get all users and check for admins
// // // //           try {
...
// // // //           } catch (usersError) {
// // // //             console.log('Users endpoint failed, trying fallback...');
            
// // // //             // 3. Final fallback - check if user is already logged in as admin
// // // //             if (user && isAdmin()) {
// // // //               setAdminExists(true);
// // // //               console.log('Admin exists (user is admin):', true);
// // // //             } else {
...
// // // //     // Trim all form values to remove any accidental spaces
...
// // // //     setAdminExists(false);
// // // //     toast.info('Manual override enabled. You can now try to register an admin.');
// // // //   };
...
// // // //   // If admin already exists and no manual override, don't show the form
// // // //   if (adminExists && !manualOverride) {
// // // //     return (
// // // //       <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
...
// // // //             className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 mb-3"
// // // //           >
// // // //             Go to Login
// // // //           </button>
// // // //           <button
// // // //             onClick={handleManualOverride}
// // // //             className="bg-yellow-600 text-white px-4 py-2 rounded-md hover:bg-yellow-700 block w-full mt-2"
// // // //           >
// // // //             Manual Override (Admin Check returned false but admin exists)
// // // //           </button>
// // // //         </div>
// // // //       </div>
// // // //     );
...
// // // //   // Show the registration form only if no admin exists or manual override is enabled
// // // //   return (
// // // //     <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
// // // //       <h3 className="text-xl font-bold mb-4 text-center">
// // // //         {manualOverride ? 'Admin Registration (Manual Override)' : 'Initial Admin Setup'}
// // // //       </h3>
// // // //       <p className="text-gray-600 mb-4 text-center text-sm">
// // // //         {manualOverride 
// // // //           ? 'Manual override enabled. Proceed with caution.' 
...
// // // //             onChange={handleChange}
// // // //             className="w-full p-2 border border-gray-300 rounded mt-1"
// // // //             placeholder="Enter the admin setup key (ADMIN_SETUP_2024)"
// // // //             disabled={loading}
// // // //           />
// // // //           <p className="text-xs text-gray-500 mt-1">Hint: ADMIN_SETUP_2024 (no spaces)</p>
// // // //         </div>
...
// // // //             className="w-full bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 mt-2"
// // // //           >
...
// // //       // Automatically log in the new admin using the auth context login function
// // //       try {
// // //         // Use the auth context's login function instead of direct API call
// // //         const loginResult = await login(trimmedFormData.email, trimmedFormData.password);
...
// // //             navigate('/dashboard');
// // //           } else {
// // //             toast.info('Please try logging in with your credentials.');
// // //           }
// // //         } catch (loginError) {
// // //           console.log('Auto-login after failed registration attempt:', loginError);
// // //           toast.info('Please try logging in with your credentials.');
...
//       if (error.response?.status === 403) {
//         const errorMessage = error.response.data?.error || 'Admin already exists. Cannot create additional admin accounts.';
//         setRegistrationError(errorMessage);
//         toast.error(errorMessage);
...
//         <div>
//           <label className="block text-sm font-medium text-gray-700">Confirm Passwordt *</label>
//           <input
//             type="password"
//             name="confirmPassword"
//             required
...
const AdminRegistrationForm = ({ onSuccess }) => {
  ...
  useEffect(() => {
    const checkAdminExists = async () => {
      try {
        ...
        try {
          // 1. Try the correct API endpoint first
          const response = await api.get('/admin/admin-exists', { // Removed duplicate /api
            timeout: 10000
          });
          setAdminExists(response.data.adminExists);
          console.log('Admin exists (API):', response.data.adminExists);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Try the correct API endpoint - removed duplicate /api
      const response = await api.post('/admin/register-admin', {
        name: trimmedFormData.name,
        email: trimmedFormData.email,
        password: trimmedFormData.password,
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Confirmt Password *</label>
          <input
            type="password"
            name="confirmPassword"
            required
